...
var FrancisGenerator = yeoman.generators.Base.extend({
  init: function() {
  ...
  promptTask: function() {
    ...
    this.log(yosay('You\'re using Francis Bond\'s fantastic generator.'));
  ...
  extras: function() {
    ...
    this.copy('env', '.env');
    this.copy('_static.cfg', '_static.cfg');
...
module.exports = FrancisGenerator;